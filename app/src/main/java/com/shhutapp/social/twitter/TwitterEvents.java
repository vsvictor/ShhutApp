...
import com.shhutapp.social.common.LogoutListener;
import com.shhutapp.social.common.PostListener;
...
public final class TwitterEvents {
	...
	/**
	 * Associate the given listener with this Twitter object. The listener's callback interface will be invoked when
