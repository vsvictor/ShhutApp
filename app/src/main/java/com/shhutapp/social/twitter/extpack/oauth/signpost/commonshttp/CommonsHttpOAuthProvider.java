 ...
 */
package com.shhutapp.social.twitter.extpack.oauth.signpost.commonshttp;
...
import com.shhutapp.social.twitter.extpack.oauth.signpost.AbstractOAuthProvider;
...
public class CommonsHttpOAuthProvider extends AbstractOAuthProvider {
    ...
    @Override
    protected com.shhutapp.social.twitter.extpack.oauth.signpost.http.HttpResponse sendRequest(HttpRequest request) throws Exception {
        HttpResponse response = httpClient.execute((HttpUriRequest) request.unwrap());
        return new HttpResponseAdapter(response);
    }

    @Override
    protected void closeConnection(HttpRequest request, com.shhutapp.social.twitter.extpack.oauth.signpost.http.HttpResponse response)
            throws Exception {
        if (response != null) {
