...
public final class Util {
	 ...
	 * 
	 * Note that the HTTP method override is used on non-GET requests. (i.e. requests are made as "POST" with method
	...
	/**
	 * Parse a server response into a JSON Object. This is a basic implementation using org.json.JSONObject
	 * representation. More sophisticated applications may wish to do their own parsing.
	 * 
	 * The parsed JSON is checked for a variety of error fields and a FacebookException is thrown if an error condition
	 * is set, populated with the error message and error type or code if available.
	 * 
	 * @param response
